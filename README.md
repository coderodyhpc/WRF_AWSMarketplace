...
◻️ Features:
The WRF interface allows model-users the generation of single and nested domains.
...
MPAS interface works with global meshes and will set up most parameters based on mesh selection.  
